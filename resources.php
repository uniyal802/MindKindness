...
<a class="navbar-brand w-100" href="index.php">MindKindness</a>
...
<li class="nav-item active"><a href="resources.php" class="nav-link">Resources</a></li>
...
<!-- END nav -->
<section class="hero-wrap hero-wrap-2" style="background-image:url(images/resources.webp)" data-stellar-background-ratio="0.5">
<div class="overlay"></div>
<div class="container">
<div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center">
<div class="col-md-9 ftco-animate text-center">
<h1 class="mb-3 bread">Interactive Quizzes</h1>
<h1 class="mb-3 bread">&amp;</h1>
<h1 class="mb-3 bread">Progress Viewer</h1>
...
<a href="#" class="img w-100 mb-3" style="background-image: url(images/gettyimages-929246190-1567442838.jpg);"></a>
<div class="text w-100 text-center">
<h3><a href="Quiz_ocd.php">Quiz for OCD</a></h3>
</div>
</div>
</div>
<div class="col-md-4">
<div class="classes w-100 ftco-animate">
<a href="#" class="img w-100 mb-3" style="background-image: url(images/sd-1.jpg);"></a>
<div class="text w-100 text-center">
<h3><a href="Quiz_dep.php">Quiz for Depression</a></h3>
</div>
</div>
</div>
<div class="col-md-4">
<div class="classes w-100 ftco-animate">
<a href="#" class="img w-100 mb-3" style="background-image: url(images/Taking-Anxiety.webp);"></a>
<div class="text w-100 text-center">
<h3><a href="Quiz_p.php">Quiz for Anxiety</a></h3>
</div>
</div>
</div>
<div class="col-md-4">
<div class="classes w-100 ftco-animate">
<a href="#" class="img w-100 mb-3" style="background-image: url(images/pompano-blog-1.webp);"></a>
<div class="text w-100 text-center">
<h3><a href="Quiz_adhd.php">Quiz for ADHD</a></h3>
</div>
</div>
</div>
...
<div class="col-md-4">
<div class="classes w-100 ftco-animate">
<a href="#" class="img w-100 mb-3" style="background-image: url(images/What-is-Bipolar-Disorder.png);"></a>
<div class="text w-100 text-center">
<h3><a href="Quiz_bd.php">Bipolar Disorder Quiz</a></h3>
</div>
</div>
</div>
</div>
...
<div class="col-md">
<div class="ftco-footer-widget mb-4"><h2 class="ftco-heading-2">MindKindness</h2>
